...
let g:lmap.l.f = [':ALEFirst', 'First linter error']
nnoremap <Leader>ll :ALELast<CR>
let g:lmap.l.l = [':ALELast', 'Last linter error']
nnoremap <Leader>ln :ALENextWrap<CR>
let g:lmap.l.n = [':ALENextWrap', 'Next linter error']
nnoremap <Leader>lp :ALEPreviousWrap<CR>
let g:lmap.l.p = [':ALEPreviousWrap', 'Previous linter error']
nnoremap <Leader>ld :ALEDetail<CR>
let g:lmap.l.d = [':ALEDetail', 'Error Detail']
